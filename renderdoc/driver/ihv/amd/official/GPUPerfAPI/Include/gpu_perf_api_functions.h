...
#ifdef GPA_PIX_BUILD
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_UpdateDeviceInformation)
#endif // GPA_PIX_BUILD
...
#ifdef GPA_PIX_BUILD
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_RestartSession)
#endif // GPA_PIX_BUILD
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_EndSession)
#ifdef GPA_PIX_BUILD
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_AbortSession)
#endif // GPA_PIX_BUILD

// Session Interrogation / Configuration
#ifdef GPA_PIX_BUILD
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_SqttGetInstructionMask)
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_SqttSetInstructionMask)
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_SqttGetComputeUnitId)
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_SqttSetComputeUnitId)

// SQTT functions
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_SqttWarmup)
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_SqttBegin)
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_SqttEnd)
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_SqttGetSampleResultSize)
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_SqttGetSampleResult)

// SPM functions
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_SpmSetSampleInterval)
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_SpmSetDuration)
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_SpmBegin)
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_SpmEnd)
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_SpmGetSampleResultSize)
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_SpmGetSampleResult)
GPA_DEPRECATED_FUNCTION_PREFIX(GPA_SpmCalculateDerivedCounters)
#endif // GPA_PIX_BUILD
