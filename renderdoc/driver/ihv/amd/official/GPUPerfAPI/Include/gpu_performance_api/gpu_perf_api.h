...
GPA_LIB_DECL GpaStatus
GpaUpdateDeviceInformation(GpaContextId context_id, GpaUInt32 num_shader_engines, GpaUInt32 num_compute_units, GpaUInt32 num_simds, GpaUInt32 num_waves_per_simd);
...
/// @ingroup gpa_session_handling
GPA_LIB_DECL GpaStatus GpaRestartSession(GpaSessionId gpa_session_id);
...
///
/// @return The GPA result status of the operation. kGpaStatusOk is returned if the operation is successful.
GPA_LIB_DECL GpaStatus GpaSqttGetInstructionMask(GpaSessionId gpa_session_id, GpaSqttInstructionFlags* pSQTTInstructionMask);
...
/// @return The GPA result status of the operation. kGpaStatusOk is returned if the operation is successful.
GPA_LIB_DECL GpaStatus GpaSqttSetInstructionMask(GpaSessionId gpa_session_id, GpaSqttInstructionFlags sqttInstructionMask);
...
///
/// @return The GPA result status of the operation. kGpaStatusOk is returned if the operation is successful.
GPA_LIB_DECL GpaStatus GpaSqttGetComputeUnitId(GpaSessionId gpa_session_id, GpaUInt32* pSQTTComputeUnitId);
...
///
/// @return The GPA result status of the operation. kGpaStatusOk is returned if the operation is successful.
GPA_LIB_DECL GpaStatus GpaSqttSetComputeUnitId(GpaSessionId gpa_session_id, GpaUInt32 sqttComputeUnitId);
...
///
/// @return The GPA result status of the operation. kGpaStatusOk is returned if the operation is successful.
GPA_LIB_DECL GpaStatus GpaSqttWarmup(GpaSessionId gpa_session_id);
...
///
/// @return The GPA result status of the operation. kGpaStatusOk is returned if the operation is successful.
GPA_LIB_DECL GpaStatus GpaSqttBegin(GpaSessionId gpa_session_id, void* pCommandList);
...
///
/// @return The GPA result status of the operation. kGpaStatusOk is returned if the operation is successful.
GPA_LIB_DECL GpaStatus GpaSqttEnd(GpaSessionId gpa_session_id, void* pCommandList);
...
///
/// @return The GPA result status of the operation. kGpaStatusOk is returned if the operation is successful.
GPA_LIB_DECL GpaStatus GpaSqttGetSampleResultSize(GpaSessionId gpa_session_id, size_t* pSampleResultSizeInBytes);
...
///
/// @return The GPA result status of the operation. kGpaStatusOk is returned if the operation is successful.
GPA_LIB_DECL GpaStatus GpaSqttGetSampleResult(GpaSessionId gpa_session_id, size_t sampleResultSizeInBytes, void* pSqttResults);
...
///
/// @return The GPA result status of the operation. kGpaStatusOk is returned if the operation is successful.
GPA_LIB_DECL GpaStatus GpaSpmSetDuration(GpaSessionId gpa_session_id, GpaUInt32 nsDuration);
...
///
/// @return The GPA result status of the operation. kGpaStatusOk is returned if the operation is successful.
GPA_LIB_DECL GpaStatus GpaSpmBegin(GpaSessionId gpa_session_id, void* pCommandList);
...
///
/// @return The GPA result status of the operation. kGpaStatusOk is returned if the operation is successful.
GPA_LIB_DECL GpaStatus GpaSpmEnd(GpaSessionId gpa_session_id, void* pCommandList);
...
///
/// @return The GPA result status of the operation. kGpaStatusOk is returned if the operation is successful.
GPA_LIB_DECL GpaStatus GpaSpmGetSampleResultSize(GpaSessionId gpa_session_id, size_t* pSampleResultSizeInBytes);
...
///
/// @return The GPA result status of the operation. kGpaStatusOk is returned if the operation is successful.
GPA_LIB_DECL GpaStatus GpaSpmGetSampleResult(GpaSessionId gpa_session_id, size_t sampleResultSizeInBytes, void* pSqttResults);
...
/// @param [out] derived_counter_results Counter results of derivedCounterCount * timestamps entries.
///
/// @return The GPA result status of the operation. kGpaStatusOk is returned if the operation is successful.
