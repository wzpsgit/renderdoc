...
typedef GpaStatus (*GpaUpdateDeviceInformationPtrType)(GpaContextId,
                                                         GpaUInt32,
                                                         GpaUInt32,
                                                         GpaUInt32,
                                                         GpaUInt32);
...
/// Typedef for a function pointer for GpaRestartSession.
typedef GpaStatus (*GpaRestartSessionPtrType)(GpaSessionId);
...
/// Typedef for a function pointer for GpaSqttWarmup
typedef GpaStatus (*GpaSqttWarmupPtrType)(GpaSessionId);
...
typedef GpaStatus (*GpaSpmCalculateDerivedCountersPtrType)(GpaSessionId,
                                                             GpaSpmData*,
                                                             GpaUInt32,
                                                             GpaUInt64*);
